...
from minigpt4.datasets.datasets.aok_vqa_datasets import AOKVQADataset,AOKVQAPOPEDataset,AOKVQAPHDDataset, OKVQADataset,AOKVQAVQADataset
...
@registry.register_builder("pope")
class POPEBuilder(BaseDatasetBuilder):
    train_dataset_cls = AOKVQAPOPEDataset
    DATASET_CONFIG_DICT = {"default": "configs/datasets/pope/defaults.yaml"}


@registry.register_builder("vqa")
class VQABuilder(BaseDatasetBuilder):
    train_dataset_cls = AOKVQAVQADataset
    DATASET_CONFIG_DICT = {"default": "configs/datasets/vqa/defaults.yaml"}


@registry.register_builder("phd")
class PHDBuilder(BaseDatasetBuilder):
    train_dataset_cls = AOKVQAPHDDataset
    DATASET_CONFIG_DICT = {"default": "configs/datasets/phd/defaults.yaml"}
