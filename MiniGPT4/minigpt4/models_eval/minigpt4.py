...
from minigpt4.models_eval.base_model import disabled_train
from minigpt4.models_eval.minigpt_base import MiniGPTBase
from minigpt4.models_eval.Qformer import BertConfig, BertLMHeadModel
...
class MiniGPT4(MiniGPTBase):
    ...
    def __init__(
        ...
        self.llama_proj.weight.requires_grad = False
        self.llama_proj.bias.requires_grad = False
    ...
    def from_config(cls, cfg):
        ...
        q_former_model = cfg.get("q_former_model", "path to blip2_pretrained_flant5xxl.pth")
